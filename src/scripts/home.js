        ...
        Object.keys(types).forEach(typeKey => {
            ...
            if (filteredProducts.length > 0) {
                ...
                filteredProducts.forEach(item => {
                    ...
                    const activeClass = isFavorite(item.id) ? 'is-active' : '';
                    ...
                    card.innerHTML = `
                        <div class="card-top">
                            ...
                            <button class="favorite-btn ${activeClass}" data-id="${item.id}">
                ...
                if (scrollToCategory) {
                  ...
                  if (target) {
                    ...
                    card.addEventListener('click', (e) => {
                        ...
                        const isCartClick = e.target.closest('.add-to-cart-small');
                        
                        if (!isFavClick && !isCartClick) {
